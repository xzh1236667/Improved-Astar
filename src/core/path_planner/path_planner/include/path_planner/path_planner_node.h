...
public:
  ...
  bool smoothPathWithBSpline(const PathPlanner::Points3d& original_path, PathPlanner::Points3d& smoothed_path);
protected:
  /**
  ...
  bool _getPlanFromPath1(PathPlanner::Points3d& path, std::vector<geometry_msgs::PoseStamped>& plan);
...
protected:
  ...
  costmap_2d::Costmap2DROS* costmap_ros_1;   // costmap(ROS wrapper)
  costmap_2d::Costmap2DROS* costmap_ros_2;
  ...
  std::shared_ptr<PathPlanner> g_planner_1;
  std::shared_ptr<PathPlanner> g_planner_2;
  ros::Publisher plan_pub_; 
  ros::Publisher plan_pub_1;                // path planning publisher
  ros::Publisher plan_pub_2;
  ros::Publisher expand_pub_;  
  ros::Publisher expand_pub_1;             // nodes explorer publisher
  ros::Publisher expand_pub_2;
  ...
  rmp::common::geometry::BSplineCurve bspline_;
private:
